...
import com.example.rideapps.databinding.ActivityDistanceConversBinding
import java.text.DecimalFormat

class DistanceConversActivity : AppCompatActivity() {

    private val binding by viewBinding(ActivityDistanceConversBinding::inflate)

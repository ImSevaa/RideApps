...
import com.example.rideapps.databinding.ActivityTimeConversBinding
import java.text.DecimalFormat

class TimeConversActivity : AppCompatActivity() {

    private val binding by viewBinding(ActivityTimeConversBinding::inflate)
